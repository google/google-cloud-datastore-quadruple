...
public class QuadrupleBuilder {
  ...
  private static final long[][] POS_POWERS_OF_2 = { // 0: 2^0 =   1 = 0.1e1
    { 1,0x1999_9999_9999_9999L,0x9999_9999_9999_9999L,0x9999_9999_9999_999aL },// 1: 2^(2^0) =   2^1 =   2 = 0.2e1
    ...
    { 5,0xa7c5_ac47_1b47_8423L,0x0fcf_80dc_3372_1d53L,0xcddd_6e04_c059_2104L },// 6: 2^(2^5) =   2^32 =   4294967296 = 0.4294967296e10
    { 10,0x6df3_7f67_5ef6_eadfL,0x5ab9_a207_2d44_268dL,0x97df_837e_6748_956eL },// 7: 2^(2^6) =   2^64 =   18446744073709551616 = 0.18446744073709551616e20
    ...
    { 39,0x571c_bec5_54b6_0dbbL,0xd5f6_4baf_0506_840dL,0x451d_b70d_5904_029bL },// 9: 2^(2^8) =   2^256 =
    ...
    { 155,0x2252_f0e5_b397_69dcL,0x9ae2_eea3_0ca3_ade0L,0xeeaa_3c08_dfe8_4e30L },// 11: 2^(2^10) =   2^1024 =
    ...
    { 309,0x2e05_5c9a_3f6b_a793L,0x1658_3a81_6eb6_0a59L,0x22c4_b082_6cf1_ebf7L },// 12: 2^(2^11) =   2^2048 =
    ...
    { 617,0x52bb_45e9_cf23_f17fL,0x7688_c076_06e5_0364L,0xb344_79aa_9d44_9a57L },// 13: 2^(2^12) =   2^4096 =
    ...
    { 1234,0x1abc_81c8_ff5f_846cL,0x8f5e_3c98_53e3_8c97L,0x4506_0097_f3bf_9296L },// 14: 2^(2^13) =   2^8192 =
    ...
    { 2467,0x1bec_53b5_10da_a7b4L,0x4836_9ed7_7dbb_0eb1L,0x3b05_587b_2187_b41eL },// 15: 2^(2^14) =   2^16384 =
    ...
    { 4933,0x1e75_063a_5ba9_1326L,0x8abf_b8e4_6001_6ae3L,0x2800_8702_d29e_8a3cL },// 16: 2^(2^15) =   2^32768 =
    ...
    { 9865,0x243c_5d8b_b5c5_fa55L,0x40c6_d248_c588_1915L,0x4c0f_d99f_d5be_fc22L },// 17: 2^(2^16) =   2^65536 =
    ...
    { 19729,0x334a_5570_c3f4_ef3cL,0xa13c_36c4_3f97_9c90L,0xda7a_c473_555f_b7a8L },// 18: 2^(2^17) =   2^131072 =
    ...
    { 39457,0x66c3_0444_5dd9_8f3bL,0xa8c2_93a2_0e47_a41bL,0x4c5b_03dc_1260_4964L },// 19: 2^(2^18) =   2^262144 =
    ...
    { 78914,0x293f_fbf5_fb02_8cc4L,0x89d3_e5ff_4423_8406L,0x369a_339e_1bfe_8c9bL },// 20: 2^(2^19) =   2^524288 =
    ...
    { 157827,0x4277_92fb_b68e_5d20L,0x7b29_7cd9_fc15_4b62L,0xf091_4211_4aa9_a20cL },// 21: 2^(2^20) =   2^1048576 =
    ...
    { 315653,0xac92_bc65_ad5c_08fcL,0x00be_eb11_5a56_6c19L,0x4ba8_82d8_a462_2437L },// 22: 2^(2^21) =   2^2097152 =
    ...
    { 631306,0x7455_8144_0f92_e80eL,0x4da8_22cf_7f89_6f41L,0x509d_5986_7816_4ecdL },// 23: 2^(2^22) =   2^4194304 =
    ...
    { 1262612,0x34dd_99b4_c695_23a5L,0x64bc_2e8f_0d8b_1044L,0xb03b_1c96_da5d_d349L },// 24: 2^(2^23) =   2^8388608 =
    ...
    { 2525223,0x6d2b_bea9_d6d2_5a08L,0xa0a4_606a_88e9_6b70L,0x1820_63bb_c2fe_8520L },// 25: 2^(2^24) =   2^16777216 =
    ...
    { 5050446,0x2e8e_47d6_3bfd_d6e3L,0x2b55_fa89_76ea_a3e9L,0x1a6b_9d30_8641_2a73L },// 26: 2^(2^25) =   2^33554432 =
    ...
    { 10100891,0x54aa_68ef_a1d7_19dfL,0xd850_5806_612c_5c8fL,0xad06_8837_fee8_b43aL },// 27: 2^(2^26) =   2^67108864 =
    ...
    { 20201782,0x1c00_464c_cb7b_ae77L,0x9e38_7778_4c77_982cL,0xd94a_f3b6_1717_404fL },// 28: 2^(2^27) =   2^134217728 =
    ...
    { 40403563,0x1ea0_99c8_be2b_6cd0L,0x8bfb_6d53_9fa5_0466L,0x6d3b_c37e_69a8_4218L },// 29: 2^(2^28) =   2^268435456 =
    ...
    { 80807125,0x24a4_57f4_66ce_8d18L,0xf2c8_f3b8_1bc6_bb59L,0xa78c_7576_92e0_2d49L },// 30: 2^(2^29) =   2^536870912 =
    ...
    { 161614249,0x3472_5667_7aba_6b53L,0x3fbf_90d3_0611_a67cL,0x1e03_9d87_e0bd_b32bL },// 31: 2^(2^30) =   2^1073741824 =
    ...
    { 323228497,0x6b72_7daf_0fd3_432aL,0x71f7_1121_f9e4_200fL,0x8fcd_9942_d486_c10cL },// 32: 2^(2^31) =   2^2147483648 =
  ...
  private static final long[][] NEG_POWERS_OF_2 = { // v18
    // 0: 2^0 =   1 = 0.1e1
    { 1,0x1999_9999_9999_9999L,0x9999_9999_9999_9999L,0x9999_9999_9999_999aL },// 1: 2^-(2^0) =   2^-1 =   0.5 = 0.5e0
    { 0,0x8000_0000_0000_0000L,0x0000_0000_0000_0000L,0x0000_0000_0000_0000L },// 2: 2^-(2^1) =   2^-2 =   0.25 = 0.25e0
    ...
    { -1,0xa000_0000_0000_0000L,0x0000_0000_0000_0000L,0x0000_0000_0000_0000L },// 4: 2^-(2^3) =   2^-8 =   0.00390625 = 0.390625e-2
    { -2,0x6400_0000_0000_0000L,0x0000_0000_0000_0000L,0x0000_0000_0000_0000L },// 5: 2^-(2^4) =   2^-16 =   0.0000152587890625 = 0.152587890625e-4
    ...
    { -19,0x8ac7_2304_89e8_0000L,0x0000_0000_0000_0000L,0x0000_0000_0000_0000L },// 8: 2^-(2^7) =   2^-128 =
    ...
    { -77,0xdd15_fe86_affa_d912L,0x49ef_0eb7_13f3_9ebeL,0xaa98_7b6e_6fd2_a002L },// 10: 2^-(2^9) =   2^-512 =
    ...
    { -154,0xbeee_fb58_4aff_8603L,0xaafb_550f_facf_d8faL,0x5ca4_7e4f_88d4_5371L },// 11: 2^-(2^10) =   2^-1024 =
    ...
    { -616,0x4f37_1b33_99fc_2ab0L,0x8170_041c_9feb_05aaL,0xc7c3_4344_7c75_bcf6L },// 13: 2^-(2^12) =   2^-4096 =
    ...
    { -1233,0xf51e_9281_7901_3fd3L,0xde4b_d12c_de4d_985cL,0x4a57_3ca6_f94b_ff14L },// 14: 2^-(2^13) =   2^-8192 =
    ...
    { -2466,0xeab3_8812_7bcc_aff7L,0x1667_6391_42b9_fbaeL,0x775e_c999_5e10_39fbL },// 15: 2^-(2^14) =   2^-16384 =
    ...
    { -4932,0xd72c_b2a9_5c7e_f6ccL,0xe81b_f1e8_25ba_7515L,0xc2fe_b521_d6cb_5dcdL },// 16: 2^-(2^15) =   2^-32768 =
    ...
    { -78913,0x9ee0_197c_8dcd_55bfL,0x2b2b_9b94_2c38_f4a2L,0x0f8b_a634_e9c7_06aeL },// 20: 2^-(2^19) =   2^-524288 =
    ...
    { -315652,0x25f9_cc30_8cee_f4f3L,0x40f1_9543_911a_4546L,0xa2cd_3894_52cf_c366L },// 22: 2^-(2^21) =   2^-2097152 =
    ...
    { -631305,0x3855_97b0_d47e_76b8L,0x1b9f_67e1_03bf_2329L,0xc311_9848_5959_85f7L },// 23: 2^-(2^22) =   2^-4194304 =
    ...
    { -40403562,0xd5fa_8c82_1ec0_c24aL,0xa80e_46e7_64e0_f8b0L,0xa727_6bfa_432f_ac7eL },// 29: 2^-(2^28) =   2^-268435456 =
    ...
    { -80807124,0xb2da_e307_426f_6791L,0xc970_b82f_58b1_2918L,0x0472_592f_7f39_190eL },// 30: 2^-(2^29) =   2^-536870912 =
    ...
    { -161614248,0x7cf5_1edd_8a15_f1c9L,0x656d_ab34_98f8_e697L,0x12da_a2a8_0e53_c807L },// 31: 2^-(2^30) =   2^-1073741824 =
    ...
    { -323228496,0x3cfe_609a_b588_3c50L,0xbec8_b5d2_2b19_8871L,0xe184_7770_3b46_22b4L },// 32: 2^-(2^31) =   2^-2147483648 =
  ...
  private int parseMantissa(byte[] digits,long[] mantissa) {
    ...
    if ((digits).length - firstDigit > MAX_MANTISSA_LENGTH) {
      ...
      byte[] truncated = this.truncatedMantissa;
  ...
  private long findBinaryExponent(long exp10,long[] mantissa) {
    long mant10 = mantissa[0] << 31 | ((mantissa[1]) >>> (1)); // Higher 63 bits of the mantissa, in range
  ...
  private long[] multPacked3x64_AndAdjustExponent(long[] factor1,long[] factor2) {
    ...
    result = pack_6x32_to_3x64(this.buffer12x32, result);
  ...
  private long[] multUnpacked6x32byPacked(long[] factor1,long[] factor2,long[] product) {
    ...
    unpack_3x64_to_6x32(factor2, this.buffer6x32B); // It's the powerOf2, with exponent in 0'th word
    factor2 = this.buffer6x32B;

    int maxFactIdx = (factor1).length;

    for (int i = (maxFactIdx) - 1; i >= (0); i--) { // compute partial 32-bit products
      for (int j = (maxFactIdx) - 1; j >= (0); j--) {
        long part = factor1[i] * factor2[j];
  ...
  //     affected.
  private long[] pack_6x32_to_3x64(long[] unpackedMant,long[] result) {
