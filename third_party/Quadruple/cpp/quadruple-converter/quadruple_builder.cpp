...
namespace util {
  ...
  static std::array<std::array<uint64_t, 4>, 33> POS_POWERS_OF_2 = { // 0: 2^0 =   1 = 0.1e1
     static_cast<uint64_t>(1),0x1999999999999999LL,0x9999999999999999LL,0x999999999999999aLL ,// 1: 2^(2^0) =   2^1 =   2 = 0.2e1
     static_cast<uint64_t>(1),0x3333333333333333LL,0x3333333333333333LL,0x3333333333333334LL ,// ***
    // 2: 2^(2^1) =   2^2 =   4 = 0.4e1
     static_cast<uint64_t>(1),0x6666666666666666LL,0x6666666666666666LL,0x6666666666666667LL ,// ***
    // 3: 2^(2^2) =   2^4 =   16 = 0.16e2
     static_cast<uint64_t>(2),0x28f5c28f5c28f5c2LL,0x8f5c28f5c28f5c28LL,0xf5c28f5c28f5c290LL ,// ***
    // 4: 2^(2^3) =   2^8 =   256 = 0.256e3
     static_cast<uint64_t>(3),0x4189374bc6a7ef9dLL,0xb22d0e5604189374LL,0xbc6a7ef9db22d0e6LL ,// ***
    // 5: 2^(2^4) =   2^16 =   65536 = 0.65536e5
     static_cast<uint64_t>(5),0xa7c5ac471b478423LL,0x0fcf80dc33721d53LL,0xcddd6e04c0592104LL ,// 6: 2^(2^5) =   2^32 =   4294967296 = 0.4294967296e10
     static_cast<uint64_t>(10),0x6df37f675ef6eadfLL,0x5ab9a2072d44268dLL,0x97df837e6748956eLL ,// 7: 2^(2^6) =   2^64 =   18446744073709551616 = 0.18446744073709551616e20
     static_cast<uint64_t>(20),0x2f394219248446baLL,0xa23d2ec729af3d61LL,0x0607aa0167dd94cbLL ,// 8: 2^(2^7) =   2^128 =   340282366920938463463374607431768211456 =
    // 0.340282366920938463463374607431768211456e39
     static_cast<uint64_t>(39),0x571cbec554b60dbbLL,0xd5f64baf0506840dLL,0x451db70d5904029bLL ,// 9: 2^(2^8) =   2^256 =
    ...
    // 0.11579208923731619542357098500868790785326998466564056403945758401e78
     static_cast<uint64_t>(78),0x1da48ce468e7c702LL,0x6520247d3556476dLL,0x1469caf6db224cfaLL ,// ***
    // 10: 2^(2^9) =   2^512 =
    ...
    // 0.13407807929942597099574024998205846127479365820592393377723561444e155
     static_cast<uint64_t>(155),0x2252f0e5b39769dcLL,0x9ae2eea30ca3ade0LL,0xeeaa3c08dfe84e30LL ,// 11: 2^(2^10) =   2^1024 =
    ...
    // 0.17976931348623159077293051907890247336179769789423065727343008116e309
     static_cast<uint64_t>(309),0x2e055c9a3f6ba793LL,0x16583a816eb60a59LL,0x22c4b0826cf1ebf7LL ,// 12: 2^(2^11) =   2^2048 =
    ...
    // 0.32317006071311007300714876688669951960444102669715484032130345428e617
     static_cast<uint64_t>(617),0x52bb45e9cf23f17fLL,0x7688c07606e50364LL,0xb34479aa9d449a57LL ,// 13: 2^(2^12) =   2^4096 =
    ...
    // 0.10443888814131525066917527107166243825799642490473837803842334833e1234
     static_cast<uint64_t>(1234),0x1abc81c8ff5f846cLL,0x8f5e3c9853e38c97LL,0x45060097f3bf9296LL ,// 14: 2^(2^13) =   2^8192 =
    ...
    // 0.10907481356194159294629842447337828624482641619962326924318327862e2467
     static_cast<uint64_t>(2467),0x1bec53b510daa7b4LL,0x48369ed77dbb0eb1LL,0x3b05587b2187b41eLL ,// 15: 2^(2^14) =   2^16384 =
    ...
    // 0.11897314953572317650857593266280071307634446870965102374726748212e4933
     static_cast<uint64_t>(4933),0x1e75063a5ba91326LL,0x8abfb8e460016ae3LL,0x28008702d29e8a3cLL ,// 16: 2^(2^15) =   2^32768 =
    ...
    // 0.14154610310449547890015530277449516013481307114723881672343857483e9865
     static_cast<uint64_t>(9865),0x243c5d8bb5c5fa55LL,0x40c6d248c5881915LL,0x4c0fd99fd5befc22LL ,// 17: 2^(2^16) =   2^65536 =
    ...
    // 0.20035299304068464649790723515602557504478254755697514192650169737e19729
     static_cast<uint64_t>(19729),0x334a5570c3f4ef3cLL,0xa13c36c43f979c90LL,0xda7ac473555fb7a8LL ,// 18: 2^(2^17) =   2^131072 =
    ...
    // 0.40141321820360630391660606060388767343771510270414189955825538065e39457
     static_cast<uint64_t>(39457),0x66c304445dd98f3bLL,0xa8c293a20e47a41bLL,0x4c5b03dc12604964LL ,// 19: 2^(2^18) =   2^262144 =
    ...
    // 0.16113257174857604736195721184520050106440238745496695174763712505e78914
     static_cast<uint64_t>(78914),0x293ffbf5fb028cc4LL,0x89d3e5ff44238406LL,0x369a339e1bfe8c9bLL ,// 20: 2^(2^19) =   2^524288 =
    ...
    // 0.25963705678310007761265964957268828277447343763484560463573654868e157827
     static_cast<uint64_t>(157827),0x427792fbb68e5d20LL,0x7b297cd9fc154b62LL,0xf09142114aa9a20cLL ,// 21: 2^(2^20) =   2^1048576 =
    ...
    // 0.67411401254990734022690651047042454376201859485326882846944915676e315653
     static_cast<uint64_t>(315653),0xac92bc65ad5c08fcLL,0x00beeb115a566c19LL,0x4ba882d8a4622437LL ,// 22: 2^(2^21) =   2^2097152 =
    ...
    // 0.45442970191613663099961595907970650433180103994591456270882095573e631306
     static_cast<uint64_t>(631306),0x745581440f92e80eLL,0x4da822cf7f896f41LL,0x509d598678164ecdLL ,// 23: 2^(2^22) =   2^4194304 =
    ...
    // 0.20650635398358879243991194945816501695274360493029670347841664177e1262612
     static_cast<uint64_t>(1262612),0x34dd99b4c69523a5LL,0x64bc2e8f0d8b1044LL,0xb03b1c96da5dd349LL ,// 24: 2^(2^23) =   2^8388608 =
    ...
    // 0.42644874235595278724327289260856157547554200794957122157246170406e2525223
     static_cast<uint64_t>(2525223),0x6d2bbea9d6d25a08LL,0xa0a4606a88e96b70LL,0x182063bbc2fe8520LL ,// 25: 2^(2^24) =   2^16777216 =
    ...
    // 0.18185852985697380078927713277749906189248596809789408311078112486e5050446
     static_cast<uint64_t>(5050446),0x2e8e47d63bfdd6e3LL,0x2b55fa8976eaa3e9LL,0x1a6b9d3086412a73LL ,// 26: 2^(2^25) =   2^33554432 =
    ...
    // 0.33072524881739831340558051919726975471129152081195558970611353362e10100891
     static_cast<uint64_t>(10100891),0x54aa68efa1d719dfLL,0xd8505806612c5c8fLL,0xad068837fee8b43aLL ,// 27: 2^(2^26) =   2^67108864 =
    ...
    // 0.10937919020533002449982468634925923461910249420785622990340704603e20201782
     static_cast<uint64_t>(20201782),0x1c00464ccb7bae77LL,0x9e3877784c77982cLL,0xd94af3b61717404fLL ,// 28: 2^(2^27) =   2^134217728 =
    ...
    // 0.11963807249973763567102377630870670302911237824129274789063323723e40403563
     static_cast<uint64_t>(40403563),0x1ea099c8be2b6cd0LL,0x8bfb6d539fa50466LL,0x6d3bc37e69a84218LL ,// 29: 2^(2^28) =   2^268435456 =
    ...
    // 0.14313268391452478724777126233530788980596273340675193575004129517e80807125
     static_cast<uint64_t>(80807125),0x24a457f466ce8d18LL,0xf2c8f3b81bc6bb59LL,0xa78c757692e02d49LL ,// 30: 2^(2^29) =   2^536870912 =
    ...
    // 0.20486965204575262773910959587280218683219330308711312100181276813e161614249
     static_cast<uint64_t>(161614249),0x347256677aba6b53LL,0x3fbf90d30611a67cLL,0x1e039d87e0bdb32bLL ,// 31: 2^(2^30) =   2^1073741824 =
    ...
    // 0.41971574329347753848087162337676781412761959309467052555732924370e323228497
     static_cast<uint64_t>(323228497),0x6b727daf0fd3432aLL,0x71f71121f9e4200fLL,0x8fcd9942d486c10cLL ,// 32: 2^(2^31) =   2^2147483648 =
    ...
    // 0.17616130516839633532074931497918402856671115581881347960233679023e646456994
     static_cast<uint64_t>(646456994),0x2d18e84484d91f78LL,0x4079bfe7829dec6fLL,0x21551643e365abc6LL  };

  // An array of negative powers of two, each value consists of 4 longs: decimal exponent and 3 x 64
  // bits of mantissa, divided by ten. Used to find an arbitrary power of 2 (by powerOfTwo(long exp))
  static std::array<std::array<uint64_t, 4>, 33> NEG_POWERS_OF_2 = { // v18
    // 0: 2^0 =   1 = 0.1e1
     static_cast<uint64_t>(1),0x1999999999999999LL,0x9999999999999999LL,0x999999999999999aLL ,// 1: 2^-(2^0) =   2^-1 =   0.5 = 0.5e0
     static_cast<uint64_t>(0),0x8000000000000000LL,0x0000000000000000LL,0x0000000000000000LL ,// 2: 2^-(2^1) =   2^-2 =   0.25 = 0.25e0
    //      {0, 0x4000_0000_0000_0000L, 0x0000_0000_0000_0000L, 0x0000_0000_0000_0000L},
     static_cast<uint64_t>(0),0x4000000000000000LL,0x0000000000000000LL,0x0000000000000001LL ,// ***
    // 3: 2^-(2^2) =   2^-4 =   0.0625 = 0.625e-1
     static_cast<uint64_t>(-1),0xa000000000000000LL,0x0000000000000000LL,0x0000000000000000LL ,// 4: 2^-(2^3) =   2^-8 =   0.00390625 = 0.390625e-2
     static_cast<uint64_t>(-2),0x6400000000000000LL,0x0000000000000000LL,0x0000000000000000LL ,// 5: 2^-(2^4) =   2^-16 =   0.0000152587890625 = 0.152587890625e-4
     static_cast<uint64_t>(-4),0x2710000000000000LL,0x0000000000000000LL,0x0000000000000001LL ,// ***
    // 6: 2^-(2^5) =   2^-32 =   2.3283064365386962890625E-10 = 0.23283064365386962890625e-9
     static_cast<uint64_t>(-9),0x3b9aca0000000000LL,0x0000000000000000LL,0x0000000000000001LL ,// ***
    // 7: 2^-(2^6) =   2^-64 =   5.42101086242752217003726400434970855712890625E-20 =
    // 0.542101086242752217003726400434970855712890625e-19
     static_cast<uint64_t>(-19),0x8ac7230489e80000LL,0x0000000000000000LL,0x0000000000000000LL ,// 8: 2^-(2^7) =   2^-128 =
    ...
    // 0.29387358770557187699218413430556141945466638919302188037718792657e-38
     static_cast<uint64_t>(-38),0x4b3b4ca85a86c47aLL,0x098a224000000000LL,0x0000000000000001LL ,// ***
    // 9: 2^-(2^8) =   2^-256 =
    ...
    // 0.86361685550944446253863518628003995711160003644362813850237034700e-77
     static_cast<uint64_t>(-77),0xdd15fe86affad912LL,0x49ef0eb713f39ebeLL,0xaa987b6e6fd2a002LL ,// 10: 2^-(2^9) =   2^-512 =
    ...
    // 0.74583407312002067432909653154629338373764715346004068942715183331e-154
     static_cast<uint64_t>(-154),0xbeeefb584aff8603LL,0xaafb550ffacfd8faLL,0x5ca47e4f88d45371LL ,// 11: 2^-(2^10) =   2^-1024 =
    ...
    // 0.55626846462680034577255817933310101605480399511558295763833185421e-308
     static_cast<uint64_t>(-308),0x8e679c2f5e44ff8fLL,0x570f09eaa7ea7648LL,0x5961db50c6d2b888LL ,// ***
    // 12: 2^-(2^11) =   2^-2048 =
    ...
    // 0.30943460473825782754801833699711978538925563038849690459540984582e-616
     static_cast<uint64_t>(-616),0x4f371b3399fc2ab0LL,0x8170041c9feb05aaLL,0xc7c343447c75bcf6LL ,// 13: 2^-(2^12) =   2^-4096 =
    ...
    // 0.95749774609521853579467310122804202420597417413514981491308464986e-1233
     static_cast<uint64_t>(-1233),0xf51e928179013fd3LL,0xde4bd12cde4d985cLL,0x4a573ca6f94bff14LL ,// 14: 2^-(2^13) =   2^-8192 =
    ...
    // 0.91680193377742358281070619602424158297818248567928361864131947526e-2466
     static_cast<uint64_t>(-2466),0xeab388127bccaff7LL,0x1667639142b9fbaeLL,0x775ec9995e1039fbLL ,// 15: 2^-(2^14) =   2^-16384 =
    ...
    // 0.84052578577802337656566945433043815064951983621161781002720680748e-4932
     static_cast<uint64_t>(-4932),0xd72cb2a95c7ef6ccLL,0xe81bf1e825ba7515LL,0xc2feb521d6cb5dcdLL ,// 16: 2^-(2^15) =   2^-32768 =
    ...
    // 0.70648359655776364427774021878587184537374439102725065590941425796e-9864
     static_cast<uint64_t>(-9864),0xb4dc1be6604502dcLL,0xd491079b8eef6535LL,0x578d3965d24de84dLL ,// ***
    // 17: 2^-(2^16) =   2^-65536 =
    ...
    // 0.49911907220519294656590574792132451973746770423207674161425040336e-19728
     static_cast<uint64_t>(-19728),0x7fc6447bee60ea43LL,0x2548da5c8b125b27LL,0x5f42d1142f41d349LL ,// ***
    // 18: 2^-(2^17) =   2^-131072 =
    ...
    // 0.24911984823897261018394507280431349807329035271689521242878455599e-39456
     static_cast<uint64_t>(-39456),0x3fc65180f88af8fbLL,0x6a6915f383349413LL,0x063c3708b6ceb291LL ,// ***
    // 19: 2^-(2^18) =   2^-262144 =
    ...
    // 0.62060698786608744707483205572846793091942192651991171731773832448e-78913
     static_cast<uint64_t>(-78913),0x9ee0197c8dcd55bfLL,0x2b2b9b942c38f4a2LL,0x0f8ba634e9c706aeLL ,// 20: 2^-(2^19) =   2^-524288 =
    ...
    // 0.38515303338821801176537443725392116267291403078581314096728076497e-157826
     static_cast<uint64_t>(-157826),0x629963a25b8b2d79LL,0xd00b9d2286f70876LL,0xe97004700c3644fcLL ,// ***
    // 21: 2^-(2^20) =   2^-1048576 =
    ...
    // 0.14834285912814577854404052243709225888043963245995136935174170977e-315652
     static_cast<uint64_t>(-315652),0x25f9cc308ceef4f3LL,0x40f19543911a4546LL,0xa2cd389452cfc366LL ,// 22: 2^-(2^21) =   2^-2097152 =
    ...
    // 0.22005603854312903332428997579002102976620485709683755186430397089e-631305
     static_cast<uint64_t>(-631305),0x385597b0d47e76b8LL,0x1b9f67e103bf2329LL,0xc3119848595985f7LL ,// 23: 2^-(2^22) =   2^-4194304 =
    ...
    // 0.48424660099295090687215589310713586524081268589231053824420510106e-1262611
     static_cast<uint64_t>(-1262611),0x7bf795d276c12f66LL,0x66a61d62a446659aLL,0xa1a4d73bebf093d5LL ,// ***
    // 24: 2^-(2^23) =   2^-8388608 =
    ...
    // 0.23449477057322620222546775527242476219043877555386221929831430440e-2525222
     static_cast<uint64_t>(-2525222),0x3c07d96ab1ed7799LL,0xcb7355c22cc05ac0LL,0x4ffc0ab73b1f6a49LL ,// ***
    ...
    // 0.54987797426189993226257377747879918011694025935111951649826798628e-5050445
     static_cast<uint64_t>(-5050445),0x8cc4cd8c3edefb9aLL,0x6c8ff86a90a97e0cLL,0x166cfddbf98b71bfLL ,// ***
    ...
    // 0.30236578657837068435515418409027857523343464783010706819696074665e-10100890
     static_cast<uint64_t>(-10100890),0x4d67d81cc88e1228LL,0x1d7cfb06666b79b3LL,0x7b916728aaa4e70dLL ,// ***
    ...
    // 0.91425068893156809483320844568740945600482370635012633596231964471e-20201781
     static_cast<uint64_t>(-20201781),0xea0c55494e7a552dLL,0xb88cb9484bb86c61LL,0x8d44893c610bb7dFLL ,// ***
    ...
    // 0.83585432221184688810803924874542310018191301711943564624682743545e-40403562
     static_cast<uint64_t>(-40403562),0xd5fa8c821ec0c24aLL,0xa80e46e764e0f8b0LL,0xa7276bfa432fac7eLL ,// 29: 2^-(2^28) =   2^-268435456 =
    ...
    // 0.69865244796022595809958912202005005328020601847785697028605460277e-80807124
     static_cast<uint64_t>(-80807124),0xb2dae307426f6791LL,0xc970b82f58b12918LL,0x0472592f7f39190eLL ,// 30: 2^-(2^29) =   2^-536870912 =
    ...
    //      {-161614248, 0x7cf5_1edd_8a15_f1c9L, 0x656d_ab34_98f8_e697L, 0x12da_a2a8_0e53_c809L},
     static_cast<uint64_t>(-161614248),0x7cf51edd8a15f1c9LL,0x656dab3498f8e697LL,0x12daa2a80e53c807LL ,// 31: 2^-(2^30) =   2^-1073741824 =
    ...
    // 0.23825649048879510732161697817326745204151961255592397879550237608e-323228496
     static_cast<uint64_t>(-323228496),0x3cfe609ab5883c50LL,0xbec8b5d22b198871LL,0xe18477703b4622b4LL ,// 32: 2^-(2^31) =   2^-2147483648 =
    ...
    // 0.56766155260037313438164181629489689531186932477276639365773003794e-646456993
     static_cast<uint64_t>(-646456993),0x9152447b9d7cda9aLL,0x3b4d3f6110d77aadLL,0xfa81bad1c394adb4LL  };
  ...
  void QuadrupleBuilder::parse(std::vector<uint8_t>& digits,int64_t exp10) {
    exp10 += (digits).size() - 1; // digits is viewed as x.yyy below.
    this->exponent = 0;
    this->mantHi = 0;
    this->mantLo = 0;
  ...
  int32_t QuadrupleBuilder::parseMantissa(std::vector<uint8_t>& digits,std::array<uint64_t,6>& mantissa) {
    ...
    if ((digits).size() - firstDigit > MAX_MANTISSA_LENGTH) {
      bool carry = digits[MAX_MANTISSA_LENGTH] >= 5; // The highest digit to be truncated
    ...
    for (int i = ((digits).size()) - 1; i >= (firstDigit); i--) { // digits, starting from the last
  ...
  template<std::size_t N> void QuadrupleBuilder::divBuffBy10(std::array<uint64_t,N>& buffer) {
    int32_t maxIdx = (buffer).size() - 1;
    // big/endian
  ...
  int32_t QuadrupleBuilder::addCarry(std::vector<uint8_t>& digits) {
    for (int i = ((digits).size()) - 1; i >= (0); i--) { // starting with the lowest digit
      uint8_t c = digits[i];
      if (c == 9) {
        digits[i] = 0;
      } else {
  ...
  void QuadrupleBuilder::findBinaryMantissa(int64_t exp10,int64_t exp2,std::array<uint64_t,6>& mantissa) {
    ...
    if (exp2 >= EXPONENT_OF_INFINITY) {
      ...
      this->mantHi = ((product[0] << 32) + product[1]);
      this->mantLo = ((product[2] << 32) + product[3]);
    }
  }
  ...
  template<std::size_t N> bool QuadrupleBuilder::isLessThanOne(std::array<uint64_t,N>& buffer) {
  ...
  void QuadrupleBuilder::multUnpacked6x32byPacked(std::array<uint64_t,6>& factor1,std::array<uint64_t,4>& factor2,std::array<uint64_t,12>& product) {
    ...
    int32_t maxFactIdx = (factor1).size();
    ...
    for (int i = (maxFactIdx) - 1; i >= (0); i--) { // compute partial 32-bit products
      for (int j = (maxFactIdx) - 1; j >= (0); j--) {
        ...
        product[j + i] = (product[j + i] + ((part) >> (32)));
      }
    }
  ...
  template<std::size_t N> int32_t QuadrupleBuilder::roundUp(std::array<uint64_t,N>& mantissa) {
  ...
  template<std::size_t N> void QuadrupleBuilder::divBuffByPower2(std::array<uint64_t,N>& buffer,int32_t exp2) {
    ...
    if (exp2 > 0) { // Shift to the right
      ...
      for (int i = (1); i < (maxIdx); i++) {
        buffer[i] = (((buffer[i] << exp2) & LOWER_32_BITS) | ((buffer[i + 1]) >> (backShift)));
      }
  ...
  template<std::size_t N> void QuadrupleBuilder::addToBuff(std::array<uint64_t,N>& buff,int32_t idx,uint64_t summand) {
    int32_t maxIdx = idx;
    buff[maxIdx] = (buff[maxIdx] + summand); // Big-endian, the lowest word
    for (int i = (maxIdx + 1) - 1; i >= (1); i--) {              // from the lowest word upwards, except the highest
