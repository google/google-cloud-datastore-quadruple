dnl  Copyright 2021 M.Vokhmentsev
dnl  Copyright 2025 Google LLC
dnl
...
dnl  limitations under the License.
  ...
  uint64_constant(LOWER_32_BITS, 0x0000_0000_FFFF_FFFF)
  ...
  double_computed_constant(LOG2_10, f_log(10) / f_log(2))

  # Approximate value of log<sub>2</sub>(e)
  double_computed_constant(LOG2_E, 1 / f_log(2.0))

  # The value of the exponent (biased) corresponding to {@code 1.0 == 2^0}; equals to 2_147_483_647
  # ({@code 0x7FFF_FFFF}).
  int32_constant(EXPONENT_BIAS, 0x7FFF_FFFF)
  ...
  uint64_array_array_constant(POS_POWERS_OF_2,
    ...
    # 1: 2^(2^0) =   2^1 =   2 = 0.2e1
    cst_array(1, cst_uint64(0x3333_3333_3333_3333), cst_uint64(0x3333_3333_3333_3333), cst_uint64(0x3333_3333_3333_3334)), # ***
    # 2: 2^(2^1) =   2^2 =   4 = 0.4e1
    cst_array(1, cst_uint64(0x6666_6666_6666_6666), cst_uint64(0x6666_6666_6666_6666), cst_uint64(0x6666_6666_6666_6667)), # ***
    # 3: 2^(2^2) =   2^4 =   16 = 0.16e2
    cst_array(2, cst_uint64(0x28f5_c28f_5c28_f5c2), cst_uint64(0x8f5c_28f5_c28f_5c28), cst_uint64(0xf5c2_8f5c_28f5_c290)), # ***
    # 4: 2^(2^3) =   2^8 =   256 = 0.256e3
    cst_array(3, cst_uint64(0x4189_374b_c6a7_ef9d), cst_uint64(0xb22d_0e56_0418_9374), cst_uint64(0xbc6a_7ef9_db22_d0e6)), # ***
    # 5: 2^(2^4) =   2^16 =   65536 = 0.65536e5
    cst_array(5, cst_uint64(0xa7c5_ac47_1b47_8423), cst_uint64(0x0fcf_80dc_3372_1d53), cst_uint64(0xcddd_6e04_c059_2104)),
    # 6: 2^(2^5) =   2^32 =   4294967296 = 0.4294967296e10
    cst_array(10, cst_uint64(0x6df3_7f67_5ef6_eadf), cst_uint64(0x5ab9_a207_2d44_268d), cst_uint64(0x97df_837e_6748_956e)),
    # 7: 2^(2^6) =   2^64 =   18446744073709551616 = 0.18446744073709551616e20
    cst_array(20, cst_uint64(0x2f39_4219_2484_46ba), cst_uint64(0xa23d_2ec7_29af_3d61), cst_uint64(0x0607_aa01_67dd_94cb)),
    # 8: 2^(2^7) =   2^128 =   340282366920938463463374607431768211456 =
    # 0.340282366920938463463374607431768211456e39
    cst_array(39, cst_uint64(0x571c_bec5_54b6_0dbb), cst_uint64(0xd5f6_4baf_0506_840d), cst_uint64(0x451d_b70d_5904_029b)),
    # 9: 2^(2^8) =   2^256 =
    ...
    cst_array(78, cst_uint64(0x1da4_8ce4_68e7_c702), cst_uint64(0x6520_247d_3556_476d), cst_uint64(0x1469_caf6_db22_4cfa)), # ***
    # 10: 2^(2^9) =   2^512 =
    ...
    cst_array(155, cst_uint64(0x2252_f0e5_b397_69dc), cst_uint64(0x9ae2_eea3_0ca3_ade0), cst_uint64(0xeeaa_3c08_dfe8_4e30)),
    # 11: 2^(2^10) =   2^1024 =
    ...
    cst_array(309, cst_uint64(0x2e05_5c9a_3f6b_a793), cst_uint64(0x1658_3a81_6eb6_0a59), cst_uint64(0x22c4_b082_6cf1_ebf7)),
    # 12: 2^(2^11) =   2^2048 =
    ...
    cst_array(617, cst_uint64(0x52bb_45e9_cf23_f17f), cst_uint64(0x7688_c076_06e5_0364), cst_uint64(0xb344_79aa_9d44_9a57)),
    # 13: 2^(2^12) =   2^4096 =
    ...
    cst_array(1234, cst_uint64(0x1abc_81c8_ff5f_846c), cst_uint64(0x8f5e_3c98_53e3_8c97), cst_uint64(0x4506_0097_f3bf_9296)),
    # 14: 2^(2^13) =   2^8192 =
    ...
    cst_array(2467, cst_uint64(0x1bec_53b5_10da_a7b4), cst_uint64(0x4836_9ed7_7dbb_0eb1), cst_uint64(0x3b05_587b_2187_b41e)),
    # 15: 2^(2^14) =   2^16384 =
    ...
    cst_array(4933, cst_uint64(0x1e75_063a_5ba9_1326), cst_uint64(0x8abf_b8e4_6001_6ae3), cst_uint64(0x2800_8702_d29e_8a3c)),
    # 16: 2^(2^15) =   2^32768 =
    ...
    cst_array(9865, cst_uint64(0x243c_5d8b_b5c5_fa55), cst_uint64(0x40c6_d248_c588_1915), cst_uint64(0x4c0f_d99f_d5be_fc22)),
    # 17: 2^(2^16) =   2^65536 =
    ...
    cst_array(19729, cst_uint64(0x334a_5570_c3f4_ef3c), cst_uint64(0xa13c_36c4_3f97_9c90), cst_uint64(0xda7a_c473_555f_b7a8)),
    # 18: 2^(2^17) =   2^131072 =
    ...
    cst_array(39457, cst_uint64(0x66c3_0444_5dd9_8f3b), cst_uint64(0xa8c2_93a2_0e47_a41b), cst_uint64(0x4c5b_03dc_1260_4964)),
    # 19: 2^(2^18) =   2^262144 =
    ...
    cst_array(78914, cst_uint64(0x293f_fbf5_fb02_8cc4), cst_uint64(0x89d3_e5ff_4423_8406), cst_uint64(0x369a_339e_1bfe_8c9b)),
    # 20: 2^(2^19) =   2^524288 =
    ...
    cst_array(157827, cst_uint64(0x4277_92fb_b68e_5d20), cst_uint64(0x7b29_7cd9_fc15_4b62), cst_uint64(0xf091_4211_4aa9_a20c)),
    # 21: 2^(2^20) =   2^1048576 =
    ...
    cst_array(315653, cst_uint64(0xac92_bc65_ad5c_08fc), cst_uint64(0x00be_eb11_5a56_6c19), cst_uint64(0x4ba8_82d8_a462_2437)),
    # 22: 2^(2^21) =   2^2097152 =
    ...
    cst_array(631306, cst_uint64(0x7455_8144_0f92_e80e), cst_uint64(0x4da8_22cf_7f89_6f41), cst_uint64(0x509d_5986_7816_4ecd)),
    # 23: 2^(2^22) =   2^4194304 =
    ...
    cst_array(1262612, cst_uint64(0x34dd_99b4_c695_23a5), cst_uint64(0x64bc_2e8f_0d8b_1044), cst_uint64(0xb03b_1c96_da5d_d349)),
    # 24: 2^(2^23) =   2^8388608 =
    ...
    cst_array(2525223, cst_uint64(0x6d2b_bea9_d6d2_5a08), cst_uint64(0xa0a4_606a_88e9_6b70), cst_uint64(0x1820_63bb_c2fe_8520)),
    ...
    cst_array(5050446, cst_uint64(0x2e8e_47d6_3bfd_d6e3), cst_uint64(0x2b55_fa89_76ea_a3e9), cst_uint64(0x1a6b_9d30_8641_2a73)),
    ...
    cst_array(10100891, cst_uint64(0x54aa_68ef_a1d7_19df), cst_uint64(0xd850_5806_612c_5c8f), cst_uint64(0xad06_8837_fee8_b43a)),
    ...
    cst_array(20201782, cst_uint64(0x1c00_464c_cb7b_ae77), cst_uint64(0x9e38_7778_4c77_982c), cst_uint64(0xd94a_f3b6_1717_404f)),
    ...
    cst_array(40403563, cst_uint64(0x1ea0_99c8_be2b_6cd0), cst_uint64(0x8bfb_6d53_9fa5_0466), cst_uint64(0x6d3b_c37e_69a8_4218)),
    ...
    cst_array(80807125, cst_uint64(0x24a4_57f4_66ce_8d18), cst_uint64(0xf2c8_f3b8_1bc6_bb59), cst_uint64(0xa78c_7576_92e0_2d49)),
    ...
    cst_array(161614249, cst_uint64(0x3472_5667_7aba_6b53), cst_uint64(0x3fbf_90d3_0611_a67c), cst_uint64(0x1e03_9d87_e0bd_b32b)),
    ...
    cst_array(323228497, cst_uint64(0x6b72_7daf_0fd3_432a), cst_uint64(0x71f7_1121_f9e4_200f), cst_uint64(0x8fcd_9942_d486_c10c)),
  ...
  uint64_array_array_constant(NEG_POWERS_OF_2,
    ...
    cst_array(0, cst_uint64(0x8000_0000_0000_0000), cst_uint64(0x0000_0000_0000_0000), cst_uint64(0x0000_0000_0000_0000)),
    # 2: 2^-(2^1) =   2^-2 =   0.25 = 0.25e0
    #      {0, 0x4000_0000_0000_0000L, 0x0000_0000_0000_0000L, 0x0000_0000_0000_0000L},
    cst_array(0, cst_uint64(0x4000_0000_0000_0000), cst_uint64(0x0000_0000_0000_0000), cst_uint64(0x0000_0000_0000_0001)), # ***
    # 3: 2^-(2^2) =   2^-4 =   0.0625 = 0.625e-1
    cst_array(-1, cst_uint64(0xa000_0000_0000_0000), cst_uint64(0x0000_0000_0000_0000), cst_uint64(0x0000_0000_0000_0000)),
    # 4: 2^-(2^3) =   2^-8 =   0.00390625 = 0.390625e-2
    cst_array(-2, cst_uint64(0x6400_0000_0000_0000), cst_uint64(0x0000_0000_0000_0000), cst_uint64(0x0000_0000_0000_0000)),
    # 5: 2^-(2^4) =   2^-16 =   0.0000152587890625 = 0.152587890625e-4
    cst_array(-4, cst_uint64(0x2710_0000_0000_0000), cst_uint64(0x0000_0000_0000_0000), cst_uint64(0x0000_0000_0000_0001)), # ***
    # 6: 2^-(2^5) =   2^-32 =   2.3283064365386962890625E-10 = 0.23283064365386962890625e-9
    cst_array(-9, cst_uint64(0x3b9a_ca00_0000_0000), cst_uint64(0x0000_0000_0000_0000), cst_uint64(0x0000_0000_0000_0001)), # ***
    # 7: 2^-(2^6) =   2^-64 =   5.42101086242752217003726400434970855712890625E-20 =
    # 0.542101086242752217003726400434970855712890625e-19
    cst_array(-19, cst_uint64(0x8ac7_2304_89e8_0000), cst_uint64(0x0000_0000_0000_0000), cst_uint64(0x0000_0000_0000_0000)),
    # 8: 2^-(2^7) =   2^-128 =
    ...
    cst_array(-38, cst_uint64(0x4b3b_4ca8_5a86_c47a), cst_uint64(0x098a_2240_0000_0000), cst_uint64(0x0000_0000_0000_0001)), # ***
    # 9: 2^-(2^8) =   2^-256 =
    ...
    cst_array(-77, cst_uint64(0xdd15_fe86_affa_d912), cst_uint64(0x49ef_0eb7_13f3_9ebe), cst_uint64(0xaa98_7b6e_6fd2_a002)),
    # 10: 2^-(2^9) =   2^-512 =
    ...
    cst_array(-154, cst_uint64(0xbeee_fb58_4aff_8603), cst_uint64(0xaafb_550f_facf_d8fa), cst_uint64(0x5ca4_7e4f_88d4_5371)),
    # 11: 2^-(2^10) =   2^-1024 =
    ...
    cst_array(-308, cst_uint64(0x8e67_9c2f_5e44_ff8f), cst_uint64(0x570f_09ea_a7ea_7648), cst_uint64(0x5961_db50_c6d2_b888)), # ***
    # 12: 2^-(2^11) =   2^-2048 =
    ...
    cst_array(-616, cst_uint64(0x4f37_1b33_99fc_2ab0), cst_uint64(0x8170_041c_9feb_05aa), cst_uint64(0xc7c3_4344_7c75_bcf6)),
    # 13: 2^-(2^12) =   2^-4096 =
    ...
    cst_array(-1233, cst_uint64(0xf51e_9281_7901_3fd3), cst_uint64(0xde4b_d12c_de4d_985c), cst_uint64(0x4a57_3ca6_f94b_ff14)),
    # 14: 2^-(2^13) =   2^-8192 =
    ...
    cst_array(-2466, cst_uint64(0xeab3_8812_7bcc_aff7), cst_uint64(0x1667_6391_42b9_fbae), cst_uint64(0x775e_c999_5e10_39fb)),
    # 15: 2^-(2^14) =   2^-16384 =
    ...
    cst_array(-4932, cst_uint64(0xd72c_b2a9_5c7e_f6cc), cst_uint64(0xe81b_f1e8_25ba_7515), cst_uint64(0xc2fe_b521_d6cb_5dcd)),
    # 16: 2^-(2^15) =   2^-32768 =
    ...
    cst_array(-9864, cst_uint64(0xb4dc_1be6_6045_02dc), cst_uint64(0xd491_079b_8eef_6535), cst_uint64(0x578d_3965_d24d_e84d)), # ***
    # 17: 2^-(2^16) =   2^-65536 =
    ...
    cst_array(-19728, cst_uint64(0x7fc6_447b_ee60_ea43), cst_uint64(0x2548_da5c_8b12_5b27), cst_uint64(0x5f42_d114_2f41_d349)), # ***
    # 18: 2^-(2^17) =   2^-131072 =
    ...
    cst_array(-39456, cst_uint64(0x3fc6_5180_f88a_f8fb), cst_uint64(0x6a69_15f3_8334_9413), cst_uint64(0x063c_3708_b6ce_b291)), # ***
    # 19: 2^-(2^18) =   2^-262144 =
    ...
    cst_array(-78913, cst_uint64(0x9ee0_197c_8dcd_55bf), cst_uint64(0x2b2b_9b94_2c38_f4a2), cst_uint64(0x0f8b_a634_e9c7_06ae)),
    # 20: 2^-(2^19) =   2^-524288 =
    ...
    cst_array(-157826, cst_uint64(0x6299_63a2_5b8b_2d79), cst_uint64(0xd00b_9d22_86f7_0876), cst_uint64(0xe970_0470_0c36_44fc)), # ***
    # 21: 2^-(2^20) =   2^-1048576 =
    ...
    cst_array(-315652, cst_uint64(0x25f9_cc30_8cee_f4f3), cst_uint64(0x40f1_9543_911a_4546), cst_uint64(0xa2cd_3894_52cf_c366)),
    # 22: 2^-(2^21) =   2^-2097152 =
    ...
    cst_array(-631305, cst_uint64(0x3855_97b0_d47e_76b8), cst_uint64(0x1b9f_67e1_03bf_2329), cst_uint64(0xc311_9848_5959_85f7)),
    # 23: 2^-(2^22) =   2^-4194304 =
    ...
    cst_array(-1262611, cst_uint64(0x7bf7_95d2_76c1_2f66), cst_uint64(0x66a6_1d62_a446_659a), cst_uint64(0xa1a4_d73b_ebf0_93d5)), # ***
    # 24: 2^-(2^23) =   2^-8388608 =
    ...
    cst_array(-2525222, cst_uint64(0x3c07_d96a_b1ed_7799), cst_uint64(0xcb73_55c2_2cc0_5ac0), cst_uint64(0x4ffc_0ab7_3b1f_6a49)), # ***
    # 25: 2^-(2^24) =   2^-16777216 =
    ...
    cst_array(-5050445, cst_uint64(0x8cc4_cd8c_3ede_fb9a), cst_uint64(0x6c8f_f86a_90a9_7e0c), cst_uint64(0x166c_fddb_f98b_71bf)), # ***
    # 26: 2^-(2^25) =   2^-33554432 =
    ...
    cst_array(-10100890, cst_uint64(0x4d67_d81c_c88e_1228), cst_uint64(0x1d7c_fb06_666b_79b3), cst_uint64(0x7b91_6728_aaa4_e70d)), # ***
    # 27: 2^-(2^26) =   2^-67108864 =
    ...
    cst_array(-20201781, cst_uint64(0xea0c_5549_4e7a_552d), cst_uint64(0xb88c_b948_4bb8_6c61), cst_uint64(0x8d44_893c_610b_b7dF)), # ***
    # 28: 2^-(2^27) =   2^-134217728 =
    ...
    cst_array(-40403562, cst_uint64(0xd5fa_8c82_1ec0_c24a), cst_uint64(0xa80e_46e7_64e0_f8b0), cst_uint64(0xa727_6bfa_432f_ac7e)),
    # 29: 2^-(2^28) =   2^-268435456 =
    ...
    cst_array(-80807124, cst_uint64(0xb2da_e307_426f_6791), cst_uint64(0xc970_b82f_58b1_2918), cst_uint64(0x0472_592f_7f39_190e)),
    # 30: 2^-(2^29) =   2^-536870912 =
    ...
    cst_array(-161614248, cst_uint64(0x7cf5_1edd_8a15_f1c9), cst_uint64(0x656d_ab34_98f8_e697), cst_uint64(0x12da_a2a8_0e53_c807)),
    # 31: 2^-(2^30) =   2^-1073741824 =
    ...
    cst_array(-323228496, cst_uint64(0x3cfe_609a_b588_3c50), cst_uint64(0xbec8_b5d2_2b19_8871), cst_uint64(0xe184_7770_3b46_22b4)),
    # 32: 2^-(2^31) =   2^-2147483648 =
    ...
    cst_array(-646456993, cst_uint64(0x9152_447b_9d7c_da9a), cst_uint64(0x3b4d_3f61_10d7_7aad), cst_uint64(0xfa81_bad1_c394_adb4)))
  ...
  # buffers of 10 words)
  def_init()
    uint64_array(buffer4x64B, 4)
    uint64_array(buffer6x32A, 6)
    uint64_array(buffer6x32B, 6)
    uint64_array(buffer6x32C, 6)
    uint64_array(buffer12x32, 12)

  def_fn(ret_void, parse, digits_decl(digits), int32_decl(exp10))
    ...
    let(int32_decl(exp10Corr)) = fn(parseMantissa)(digits, mantissa);
    ...
    c_if(exp10 < cst(MIN_EXP10))
      return;
    c_end
    c_if(exp10 > cst(MAX_EXP10))
  ...
  def_fn(ret_int32, parseMantissa, digits_decl(digits), uint64_array_decl(mantissa, 6))
    c_for_range(i, 0, 6)
      mantissa[i] = cst_uint64(0);
    c_end

    # Skip leading zeroes
    let(int32_decl(firstDigit)) = 0;
    c_while(firstDigit < array_len(digits) c_and digits[firstDigit] == 0)
      firstDigit += 1;
    c_end
    c_if(firstDigit == array_len(digits))
      return 0; # All zeroes
    c_end
    let(int32_decl(expCorr)) = -firstDigit;

    # Limit the string length to avoid unnecessary fuss
    c_if(array_len(digits) - firstDigit > cst(MAX_MANTISSA_LENGTH))
      let(bool_decl(carry)) = digits[cst(MAX_MANTISSA_LENGTH)] >= 5; # The highest digit to be truncated

      new_digit_array(truncated, cst(MAX_MANTISSA_LENGTH));
      c_for_range(i, 0, cst(MAX_MANTISSA_LENGTH))
        truncated[i] = digits[i + firstDigit];
      c_end
      c_if(carry) # Round-up: add carry
        expCorr += fn(addCarry)(truncated); # May add an extra digit in front of it (99..99 -> 100)
      c_end
      digits = truncated;
      firstDigit = 0;
    c_end

    c_for_range_down(i, array_len(digits), firstDigit) # digits, starting from the last
      mantissa[0] |= to_uint64(digits[i]) << cst_uint64(32);
      fn(divBuffBy10)(mantissa);
    c_end
    return expCorr;
  c_end
  ...
  def_array_fn(array_size(N), ret_void, divBuffBy10, uint64_array_decl(buffer, N))
    let(int32_decl(maxIdx)) = array_len(buffer);
    # big/endian
    c_for_range(i, 0, maxIdx)
      let(uint64_decl(r)) = buffer[i] % cst_uint64(10);
      buffer[i] = int_divide(buffer[i], cst_uint64(10));
      c_if(i + 1 < maxIdx)
        buffer[i + 1] += r << cst_uint64(32);
      c_end
    c_end
  c_end
  ...
  def_array_fn(array_size(N), ret_bool, isEmpty, uint64_array_decl(buffer, N))
    c_for_range(i, 0, array_len(buffer))
      c_if(buffer[i] != cst_uint64(0))
        return false;
      c_end
    c_end
    return true;
  ...
  def_fn(ret_int32, addCarry, digits_decl(digits))
    c_for_range_down(i, array_len(digits), 0) # starting with the lowest digit
      let(digit_decl(c)) = digits[i];
      c_if(c == 9)
        digits[i] = 0;
      c_else
        digits[i] = to_digit(digits[i] + 1);
        return 0;
      c_end
    c_end
    digits[0] = 1;
  ...
  def_fn(ret_double, findBinaryExponent, int32_decl(exp10), uint64_array_decl(mantissa, 6))
    let(uint64_decl(mant10)) = mantissa[0] << cst_uint64(31) | lsr(mantissa[1], cst_uint64(1)); # Higher 63 bits of the mantissa, in range
    # 0x0CC..CCC -- 0x7FF..FFF (2^63/10 -- 2^63-1)
    # decimal value of the mantissa in range 1.0..9.9999...
    let(double_decl(mant10d)) = to_double(mant10) / cst(TWO_POW_63_DIV_10);
    return f_floor(to_double(exp10) * cst(LOG2_10) + fn(log2)(mant10d)); # Binary exponent
  c_end

  # Calculates log<sub>2</sub> of the given x
  # @param x argument that can't be 0
  # @return the value of log<sub>2</sub>(x)
  def_fn(ret_double, log2, double_decl(x))
    # x can't be 0
    return cst(LOG2_E) * f_log(x);
  c_end

  def_fn(ret_void, findBinaryMantissa, int32_decl(exp10), double_decl(exp2), uint64_array_decl(mantissa, 6))
     # pow(2, -exp2): division by 2^exp2 is multiplication by 2^(-exp2) actually
    let(uint64_array_decl(powerOf2, 4)) = field(buffer4x64B);
    fn(powerOfTwo)(-exp2, powerOf2);
    let(uint64_array_decl(product, 12)) = field(buffer12x32); # use it for the product (M * 10^E / 2^e)
  ...
  def_fn(ret_void, powerOfTwo, double_decl(exp), uint64_array_decl(power, 4))
    c_if(exp == 0)
    ...
    let(uint64_array_array_decl(powers)) = ref(POS_POWERS_OF_2);
    c_if(exp < 0)
      exp = -exp;
      powers = ref(NEG_POWERS_OF_2); # positive powers of 2 (2^0, 2^-1, 2^-2, 2^-4, 2^-8 ... 2^30)
    c_end

    # 2^31 = 0x8000_0000L; a single bit that will be shifted right at every iteration
    let(double_decl(currPowOf2)) = cst(POW_2_31);
    let(int32_decl(idx)) = 32; # Index in the table of powers
    let(bool_decl(first_power)) = true;
  ...
  def_fn(ret_void, multPacked3x64_AndAdjustExponent, uint64_array_decl(factor1, 4), uint64_array_decl(factor2, 4), uint64_array_decl(result, 4))
    ...
    let(int32_decl(expCorr)) = fn(correctPossibleUnderflow)(field(buffer12x32));
  ...
  def_fn(ret_void, multPacked3x64_simply, uint64_array_decl(factor1, 4), uint64_array_decl(factor2, 4), uint64_array_decl(result, 12))
    ...
    fn(unpack_3x64_to_6x32)(factor1, field(buffer6x32A));
    fn(unpack_3x64_to_6x32)(factor2, field(buffer6x32B));

    c_for_range_down(i, 6, 0) # compute partial 32-bit products
      c_for_range_down(j, 6, 0)
        let(uint64_decl(part)) = field(buffer6x32A)[i] * field(buffer6x32B)[j];
        result[j + i + 1] = wrap_uint64(result[j + i + 1] + (part & cst(LOWER_32_BITS)));
        result[j + i] = wrap_uint64(result[j + i] + lsr(part, cst_uint64(32)));
      c_end
    c_end

    # Carry higher bits of the product to the lower bits of the next word
    c_for_range_down(i, 12, 1)
      result[i - 1] = wrap_uint64(result[i - 1] + lsr(result[i], cst_uint64(32)));
  ...
  def_array_fn(array_size(N), ret_bool, isLessThanOne, uint64_array_decl(buffer, N))
    c_if(buffer[0] < cst_uint64(0x1999_9999))
      return true;
    c_end
    c_if(buffer[0] > cst_uint64(0x1999_9999))
      return false;
    ...
    c_for_range(i, 1, array_len(buffer))
      # so this loop can't be covered entirely
      c_if(buffer[i] < cst_uint64(0x9999_9999))
        return true;
      c_end
      c_if(buffer[i] > cst_uint64(0x9999_9999))
        return false;
  ...
  def_fn(ret_void, multUnpacked6x32byPacked, uint64_array_decl(factor1, 6), uint64_array_decl(factor2, 4), uint64_array_decl(product, 12))
    c_for_range(i, 0, array_len(product))
      product[i] = cst_uint64(0);
    c_end
    let(uint64_array_decl(unpacked2, 6)) = field(buffer6x32B);
    fn(unpack_3x64_to_6x32)(factor2, unpacked2); # It's the powerOf2, with exponent in 0'th word

    let(int32_decl(maxFactIdx)) = array_len(factor1);

    c_for_range_down(i, maxFactIdx, 0) # compute partial 32-bit products
      c_for_range_down(j, maxFactIdx, 0)
        let(uint64_decl(part)) = factor1[i] * unpacked2[j];
        product[j + i + 1] = wrap_uint64(product[j + i + 1] + (part & cst(LOWER_32_BITS)));
        product[j + i] = wrap_uint64(product[j + i] + lsr(part, cst_uint64(32)));
      c_end
    c_end

    # Carry higher bits of the product to the lower bits of the next word
    c_for_range_down(i, 12, 1)
      product[i - 1] = wrap_uint64(product[i - 1] + lsr(product[i], cst_uint64(32)));
  ...
  def_array_fn(array_size(N), ret_void, multBuffBy10, uint64_array_decl(buffer, N))
    let(int32_decl(maxIdx)) = array_len(buffer) - 1;
    buffer[0] &= cst(LOWER_32_BITS);
    buffer[maxIdx] *= cst_uint64(10);
    c_for_range_down(i, maxIdx, 0)
      buffer[i] = wrap_uint64(buffer[i] * cst_uint64(10) + lsr(buffer[i + 1], cst_uint64(32)));
      buffer[i + 1] &= cst(LOWER_32_BITS);
    c_end
  c_end
  ...
  def_array_fn(array_size(N), ret_int32, normalizeMant, uint64_array_decl(mantissa, N))
    let(int32_decl(expCorr)) = 31 - f_number_of_leading_zeros(mantissa[0]);
    c_if(expCorr != 0)
      fn(divBuffByPower2)(mantissa, expCorr);
    c_end
    return expCorr;
  c_end
  ...
  #     affected.
  def_array_fn(array_size(N, P), ret_void, pack_6x32_to_3x64, uint64_array_decl(unpackedMant, N), uint64_array_decl(result, P))
    result[1] = (unpackedMant[0] << cst_uint64(32)) + unpackedMant[1];
    result[2] = (unpackedMant[2] << cst_uint64(32)) + unpackedMant[3];
    result[3] = (unpackedMant[4] << cst_uint64(32)) + unpackedMant[5];
  c_end
  ...
  def_fn(ret_void, unpack_3x64_to_6x32, uint64_array_decl(qd192, 4), uint64_array_decl(buff_6x32, 6))
    buff_6x32[0] = lsr(qd192[1], cst_uint64(32));
    buff_6x32[1] = qd192[1] & cst(LOWER_32_BITS);
    buff_6x32[2] = lsr(qd192[2], cst_uint64(32));
    buff_6x32[3] = qd192[2] & cst(LOWER_32_BITS);
    buff_6x32[4] = lsr(qd192[3], cst_uint64(32));
    buff_6x32[5] = qd192[3] & cst(LOWER_32_BITS);
  c_end
  ...
  def_array_fn(array_size(N), ret_void, divBuffByPower2, uint64_array_decl(buffer, N), int32_decl(exp2))
    let(int32_decl(maxIdx)) = array_len(buffer) - 1;
    let(uint64_decl(backShift)) = to_uint64(32 - f_iabs(exp2));

    c_if(exp2 > 0) # Shift to the right
      let(uint64_decl(exp2Shift)) = to_uint64(exp2);
      c_for_range_down(i, maxIdx + 1, 1)
        buffer[i] = lsr(buffer[i], exp2Shift) | ((buffer[i - 1] << backShift) & cst(LOWER_32_BITS));
      c_end
      buffer[0] = lsr(buffer[0], exp2Shift); # Preserve the high half of buff[0]
    c_elsif(exp2 < 0) # Shift to the left
      let(uint64_decl(exp2Shift)) = to_uint64(-exp2);
      buffer[0] = wrap_uint64((buffer[0] << exp2Shift) | lsr(buffer[1], backShift)); # Preserve the high half of buff[0]
      c_for_range(i, 1, maxIdx)
        buffer[i] = wrap_uint64(((buffer[i] << exp2Shift) & cst(LOWER_32_BITS)) | lsr(buffer[i + 1], backShift));
      c_end
      buffer[maxIdx] = (buffer[maxIdx] << exp2Shift) & cst(LOWER_32_BITS);
    c_end
  c_end
  ...
  def_array_fn(array_size(N), ret_void, addToBuff, uint64_array_decl(buff, N), int32_decl(idx), uint64_decl(summand))
    let(int32_decl(maxIdx)) = idx;
    buff[maxIdx] = wrap_uint64(buff[maxIdx] + summand); # Big-endian, the lowest word
    c_for_range_down(i, maxIdx + 1, 1)              # from the lowest word upwards, except the highest
      c_if((buff[i] & cst(HIGHER_32_BITS)) != cst_uint64(0))
        buff[i] &= cst(LOWER_32_BITS);
        buff[i-1] += cst_uint64(1);
      c_else
        break;
      c_end
    c_end
