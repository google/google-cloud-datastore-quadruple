...
class QuadrupleBuilder(object):
  ...
  POS_POWERS_OF_2 = ( # 0: 2^0 =   1 = 0.1e1
    ...
    # 2: 2^(2^1) =   2^2 =   4 = 0.4e1
    ( 1,0x6666_6666_6666_6666,0x6666_6666_6666_6666,0x6666_6666_6666_6667 ),# ***
    # 3: 2^(2^2) =   2^4 =   16 = 0.16e2
    ( 2,0x28f5_c28f_5c28_f5c2,0x8f5c_28f5_c28f_5c28,0xf5c2_8f5c_28f5_c290 ),# ***
    # 4: 2^(2^3) =   2^8 =   256 = 0.256e3
    ( 3,0x4189_374b_c6a7_ef9d,0xb22d_0e56_0418_9374,0xbc6a_7ef9_db22_d0e6 ),# ***
    # 5: 2^(2^4) =   2^16 =   65536 = 0.65536e5
    ( 5,0xa7c5_ac47_1b47_8423,0x0fcf_80dc_3372_1d53,0xcddd_6e04_c059_2104 ),# 6: 2^(2^5) =   2^32 =   4294967296 = 0.4294967296e10
    ( 10,0x6df3_7f67_5ef6_eadf,0x5ab9_a207_2d44_268d,0x97df_837e_6748_956e ),# 7: 2^(2^6) =   2^64 =   18446744073709551616 = 0.18446744073709551616e20
    ( 20,0x2f39_4219_2484_46ba,0xa23d_2ec7_29af_3d61,0x0607_aa01_67dd_94cb ),# 8: 2^(2^7) =   2^128 =   340282366920938463463374607431768211456 =
    # 0.340282366920938463463374607431768211456e39
    ( 39,0x571c_bec5_54b6_0dbb,0xd5f6_4baf_0506_840d,0x451d_b70d_5904_029b ),# 9: 2^(2^8) =   2^256 =
    ...
    ( 78,0x1da4_8ce4_68e7_c702,0x6520_247d_3556_476d,0x1469_caf6_db22_4cfa ),# ***
    # 10: 2^(2^9) =   2^512 =
    ...
    ( 155,0x2252_f0e5_b397_69dc,0x9ae2_eea3_0ca3_ade0,0xeeaa_3c08_dfe8_4e30 ),# 11: 2^(2^10) =   2^1024 =
    ...
    ( 309,0x2e05_5c9a_3f6b_a793,0x1658_3a81_6eb6_0a59,0x22c4_b082_6cf1_ebf7 ),# 12: 2^(2^11) =   2^2048 =
    ...
    ( 617,0x52bb_45e9_cf23_f17f,0x7688_c076_06e5_0364,0xb344_79aa_9d44_9a57 ),# 13: 2^(2^12) =   2^4096 =
    ...
    ( 1234,0x1abc_81c8_ff5f_846c,0x8f5e_3c98_53e3_8c97,0x4506_0097_f3bf_9296 ),# 14: 2^(2^13) =   2^8192 =
    ...
    ( 2467,0x1bec_53b5_10da_a7b4,0x4836_9ed7_7dbb_0eb1,0x3b05_587b_2187_b41e ),# 15: 2^(2^14) =   2^16384 =
    ...
    ( 4933,0x1e75_063a_5ba9_1326,0x8abf_b8e4_6001_6ae3,0x2800_8702_d29e_8a3c ),# 16: 2^(2^15) =   2^32768 =
    ...
    ( 9865,0x243c_5d8b_b5c5_fa55,0x40c6_d248_c588_1915,0x4c0f_d99f_d5be_fc22 ),# 17: 2^(2^16) =   2^65536 =
    ...
    ( 19729,0x334a_5570_c3f4_ef3c,0xa13c_36c4_3f97_9c90,0xda7a_c473_555f_b7a8 ),# 18: 2^(2^17) =   2^131072 =
    ...
    ( 39457,0x66c3_0444_5dd9_8f3b,0xa8c2_93a2_0e47_a41b,0x4c5b_03dc_1260_4964 ),# 19: 2^(2^18) =   2^262144 =
    ...
    ( 78914,0x293f_fbf5_fb02_8cc4,0x89d3_e5ff_4423_8406,0x369a_339e_1bfe_8c9b ),# 20: 2^(2^19) =   2^524288 =
    ...
    ( 157827,0x4277_92fb_b68e_5d20,0x7b29_7cd9_fc15_4b62,0xf091_4211_4aa9_a20c ),# 21: 2^(2^20) =   2^1048576 =
    ...
    ( 315653,0xac92_bc65_ad5c_08fc,0x00be_eb11_5a56_6c19,0x4ba8_82d8_a462_2437 ),# 22: 2^(2^21) =   2^2097152 =
    ...
    ( 631306,0x7455_8144_0f92_e80e,0x4da8_22cf_7f89_6f41,0x509d_5986_7816_4ecd ),# 23: 2^(2^22) =   2^4194304 =
    ...
    ( 1262612,0x34dd_99b4_c695_23a5,0x64bc_2e8f_0d8b_1044,0xb03b_1c96_da5d_d349 ),# 24: 2^(2^23) =   2^8388608 =
    ...
    ( 2525223,0x6d2b_bea9_d6d2_5a08,0xa0a4_606a_88e9_6b70,0x1820_63bb_c2fe_8520 ),# 25: 2^(2^24) =   2^16777216 =
    ...
    ( 5050446,0x2e8e_47d6_3bfd_d6e3,0x2b55_fa89_76ea_a3e9,0x1a6b_9d30_8641_2a73 ),# 26: 2^(2^25) =   2^33554432 =
    ...
    ( 10100891,0x54aa_68ef_a1d7_19df,0xd850_5806_612c_5c8f,0xad06_8837_fee8_b43a ),# 27: 2^(2^26) =   2^67108864 =
    ...
    ( 20201782,0x1c00_464c_cb7b_ae77,0x9e38_7778_4c77_982c,0xd94a_f3b6_1717_404f ),# 28: 2^(2^27) =   2^134217728 =
    ...
    ( 40403563,0x1ea0_99c8_be2b_6cd0,0x8bfb_6d53_9fa5_0466,0x6d3b_c37e_69a8_4218 ),# 29: 2^(2^28) =   2^268435456 =
    ...
    ( 80807125,0x24a4_57f4_66ce_8d18,0xf2c8_f3b8_1bc6_bb59,0xa78c_7576_92e0_2d49 ),# 30: 2^(2^29) =   2^536870912 =
    ...
    ( 161614249,0x3472_5667_7aba_6b53,0x3fbf_90d3_0611_a67c,0x1e03_9d87_e0bd_b32b ),# 31: 2^(2^30) =   2^1073741824 =
    ...
    ( 323228497,0x6b72_7daf_0fd3_432a,0x71f7_1121_f9e4_200f,0x8fcd_9942_d486_c10c ),# 32: 2^(2^31) =   2^2147483648 =
  ...
  NEG_POWERS_OF_2 = ( # v18
    ...
    ( 0,0x8000_0000_0000_0000,0x0000_0000_0000_0000,0x0000_0000_0000_0000 ),# 2: 2^-(2^1) =   2^-2 =   0.25 = 0.25e0
    #      {0, 0x4000_0000_0000_0000L, 0x0000_0000_0000_0000L, 0x0000_0000_0000_0000L},
    ( 0,0x4000_0000_0000_0000,0x0000_0000_0000_0000,0x0000_0000_0000_0001 ),# ***
    # 3: 2^-(2^2) =   2^-4 =   0.0625 = 0.625e-1
    ( -1,0xa000_0000_0000_0000,0x0000_0000_0000_0000,0x0000_0000_0000_0000 ),# 4: 2^-(2^3) =   2^-8 =   0.00390625 = 0.390625e-2
    ( -2,0x6400_0000_0000_0000,0x0000_0000_0000_0000,0x0000_0000_0000_0000 ),# 5: 2^-(2^4) =   2^-16 =   0.0000152587890625 = 0.152587890625e-4
    ( -4,0x2710_0000_0000_0000,0x0000_0000_0000_0000,0x0000_0000_0000_0001 ),# ***
    # 6: 2^-(2^5) =   2^-32 =   2.3283064365386962890625E-10 = 0.23283064365386962890625e-9
    ( -9,0x3b9a_ca00_0000_0000,0x0000_0000_0000_0000,0x0000_0000_0000_0001 ),# ***
    # 7: 2^-(2^6) =   2^-64 =   5.42101086242752217003726400434970855712890625E-20 =
    # 0.542101086242752217003726400434970855712890625e-19
    ( -19,0x8ac7_2304_89e8_0000,0x0000_0000_0000_0000,0x0000_0000_0000_0000 ),# 8: 2^-(2^7) =   2^-128 =
    ...
    ( -38,0x4b3b_4ca8_5a86_c47a,0x098a_2240_0000_0000,0x0000_0000_0000_0001 ),# ***
    # 9: 2^-(2^8) =   2^-256 =
    ...
    ( -77,0xdd15_fe86_affa_d912,0x49ef_0eb7_13f3_9ebe,0xaa98_7b6e_6fd2_a002 ),# 10: 2^-(2^9) =   2^-512 =
    ...
    ( -154,0xbeee_fb58_4aff_8603,0xaafb_550f_facf_d8fa,0x5ca4_7e4f_88d4_5371 ),# 11: 2^-(2^10) =   2^-1024 =
    ...
    ( -308,0x8e67_9c2f_5e44_ff8f,0x570f_09ea_a7ea_7648,0x5961_db50_c6d2_b888 ),# ***
    # 12: 2^-(2^11) =   2^-2048 =
    ...
    ( -616,0x4f37_1b33_99fc_2ab0,0x8170_041c_9feb_05aa,0xc7c3_4344_7c75_bcf6 ),# 13: 2^-(2^12) =   2^-4096 =
    ...
    ( -1233,0xf51e_9281_7901_3fd3,0xde4b_d12c_de4d_985c,0x4a57_3ca6_f94b_ff14 ),# 14: 2^-(2^13) =   2^-8192 =
    ...
    ( -2466,0xeab3_8812_7bcc_aff7,0x1667_6391_42b9_fbae,0x775e_c999_5e10_39fb ),# 15: 2^-(2^14) =   2^-16384 =
    ...
    ( -4932,0xd72c_b2a9_5c7e_f6cc,0xe81b_f1e8_25ba_7515,0xc2fe_b521_d6cb_5dcd ),# 16: 2^-(2^15) =   2^-32768 =
    ...
    ( -9864,0xb4dc_1be6_6045_02dc,0xd491_079b_8eef_6535,0x578d_3965_d24d_e84d ),# ***
    # 17: 2^-(2^16) =   2^-65536 =
    ...
    ( -19728,0x7fc6_447b_ee60_ea43,0x2548_da5c_8b12_5b27,0x5f42_d114_2f41_d349 ),# ***
    # 18: 2^-(2^17) =   2^-131072 =
    ...
    ( -39456,0x3fc6_5180_f88a_f8fb,0x6a69_15f3_8334_9413,0x063c_3708_b6ce_b291 ),# ***
    # 19: 2^-(2^18) =   2^-262144 =
    ...
    ( -78913,0x9ee0_197c_8dcd_55bf,0x2b2b_9b94_2c38_f4a2,0x0f8b_a634_e9c7_06ae ),# 20: 2^-(2^19) =   2^-524288 =
    ...
    ( -157826,0x6299_63a2_5b8b_2d79,0xd00b_9d22_86f7_0876,0xe970_0470_0c36_44fc ),# ***
    # 21: 2^-(2^20) =   2^-1048576 =
    ...
    ( -315652,0x25f9_cc30_8cee_f4f3,0x40f1_9543_911a_4546,0xa2cd_3894_52cf_c366 ),# 22: 2^-(2^21) =   2^-2097152 =
    ...
    ( -631305,0x3855_97b0_d47e_76b8,0x1b9f_67e1_03bf_2329,0xc311_9848_5959_85f7 ),# 23: 2^-(2^22) =   2^-4194304 =
    ...
    ( -1262611,0x7bf7_95d2_76c1_2f66,0x66a6_1d62_a446_659a,0xa1a4_d73b_ebf0_93d5 ),# ***
    # 24: 2^-(2^23) =   2^-8388608 =
    ...
    ( -2525222,0x3c07_d96a_b1ed_7799,0xcb73_55c2_2cc0_5ac0,0x4ffc_0ab7_3b1f_6a49 ),# ***
    ...
    ( -5050445,0x8cc4_cd8c_3ede_fb9a,0x6c8f_f86a_90a9_7e0c,0x166c_fddb_f98b_71bf ),# ***
    ...
    ( -10100890,0x4d67_d81c_c88e_1228,0x1d7c_fb06_666b_79b3,0x7b91_6728_aaa4_e70d ),# ***
    ...
    ( -20201781,0xea0c_5549_4e7a_552d,0xb88c_b948_4bb8_6c61,0x8d44_893c_610b_b7dF ),# ***
    ...
    ( -40403562,0xd5fa_8c82_1ec0_c24a,0xa80e_46e7_64e0_f8b0,0xa727_6bfa_432f_ac7e ),# 29: 2^-(2^28) =   2^-268435456 =
    ...
    ( -80807124,0xb2da_e307_426f_6791,0xc970_b82f_58b1_2918,0x0472_592f_7f39_190e ),# 30: 2^-(2^29) =   2^-536870912 =
    ...
    ( -161614248,0x7cf5_1edd_8a15_f1c9,0x656d_ab34_98f8_e697,0x12da_a2a8_0e53_c807 ),# 31: 2^-(2^30) =   2^-1073741824 =
    ...
    ( -323228496,0x3cfe_609a_b588_3c50,0xbec8_b5d2_2b19_8871,0xe184_7770_3b46_22b4 ),# 32: 2^-(2^31) =   2^-2147483648 =
    ...
    ( -646456993,0x9152_447b_9d7c_da9a,0x3b4d_3f61_10d7_7aad,0xfa81_bad1_c394_adb4 ) )
  ...
  def parse(self, digits,exp10):
    ...
    if exp10 < self.MIN_EXP10:
      return;
    
    if exp10 > self.MAX_EXP10:
  ...
  def doAvoidDecimal128CollisionsWithDouble(self, ):
    # Collisions may occur when the result matches some double.
    if self.mantLo == 0 and (self.mantHi & 0XFFF) == 0:
  ...
  def parseMantissa(self, digits,mantissa):
    ...
    # Skip leading zeroes
    firstDigit = 0;
    while firstDigit < len((digits)) and digits[firstDigit] == 0:
      firstDigit += 1;
    
    if firstDigit == len((digits)):
      return 0; # All zeroes
    ...
    if len((digits)) - firstDigit > self.MAX_MANTISSA_LENGTH:
      ...
      if carry: # Round-up: add carry
        expCorr += self.addCarry(truncated); # May add an extra digit in front of it (99..99 -> 100)
  ...
  def addCarry(self, digits):
    for i in range((len((digits))) - 1, (0) - 1, -1): # starting with the lowest digit
      c = digits[i];
      if c == 9:
        digits[i] = 0;
      else:
  ...
  def findBinaryExponent(self, exp10,mantissa):
  ...
  def findBinaryMantissa(self, exp10,exp2,mantissa):
    ...
    exp2 += self.normalizeMant(product);
    exp2 += self.EXPONENT_BIAS; # add bias
    ...
    # higher bits.
    self.addToBuff(product, 5, self.MAX_ERROR); # to compensate possible inaccuracy
    # true if bits 128-191 are within 2 * MAX_ERROR, i.e., the conversion appears exact
    exact192 = product[4] == 0 and product[5] >= 0 and product[5] <= 2 * self.MAX_ERROR;
    prev128 = product[3];
  ...
  def multPacked3x64_simply(self, factor1,factor2,result):
    ...
    self.unpack_3x64_to_6x32(factor1, self.buffer6x32A);
    self.unpack_3x64_to_6x32(factor2, self.buffer6x32B);
  ...
  def isLessThanOne(self, buffer):
    if buffer[0] < 0x1999_9999:
      return True;
  ...
  def multBuffBy10(self, buffer):
    maxIdx = len((buffer)) - 1;
    buffer[0] &= self.LOWER_32_BITS;
    buffer[maxIdx] *= 10;
    for i in range((maxIdx) - 1, (0) - 1, -1):
      buffer[i] = ((buffer[i] * 10 + ((buffer[i + 1]) >> (32))) & 0xffffffffffffffff);
      buffer[i + 1] &= self.LOWER_32_BITS;
  ...
  def normalizeMant(self, mantissa):
    expCorr = 31 - (66-len(bin((mantissa[0]))));
    if expCorr != 0:
      self.divBuffByPower2(mantissa, expCorr);
  ...
  def roundUp(self, mantissa):
    self.addToBuff(mantissa, 4, 0x8000_0000); # round-up, if bits 128..159 >= 0x8000_0000L
    if (mantissa[0] & (self.HIGHER_32_BITS << 1)) != 0:
      # carry's got propagated beyond the highest bit
      self.divBuffByPower2(mantissa, 1);
      return 1;
  ...
  #     affected.
  def pack_6x32_to_3x64(self, unpackedMant,result):
  ...
  def unpack_3x64_to_6x32(self, qd192,buff_6x32):
    buff_6x32[0] = ((qd192[1]) >> (32));
    buff_6x32[1] = qd192[1] & self.LOWER_32_BITS;
    buff_6x32[2] = ((qd192[2]) >> (32));
    buff_6x32[3] = qd192[2] & self.LOWER_32_BITS;
    buff_6x32[4] = ((qd192[3]) >> (32));
    buff_6x32[5] = qd192[3] & self.LOWER_32_BITS;
  ...
  def addToBuff(self, buff,idx,summand):
    maxIdx = idx;
    buff[maxIdx] = ((buff[maxIdx] + summand) & 0xffffffffffffffff); # Big-endian, the lowest word
