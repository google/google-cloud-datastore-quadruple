...
export class QuadrupleBuilder {
  ...
  static POS_POWERS_OF_2: bigint[][] = [ // 0: 2^0 =   1 = 0.1e1
    [ 1n,0x1999_9999_9999_9999n,0x9999_9999_9999_9999n,0x9999_9999_9999_999an ],// 1: 2^(2^0) =   2^1 =   2 = 0.2e1
    [ 1n,0x3333_3333_3333_3333n,0x3333_3333_3333_3333n,0x3333_3333_3333_3334n ],// ***
    // 2: 2^(2^1) =   2^2 =   4 = 0.4e1
    [ 1n,0x6666_6666_6666_6666n,0x6666_6666_6666_6666n,0x6666_6666_6666_6667n ],// ***
    // 3: 2^(2^2) =   2^4 =   16 = 0.16e2
    [ 2n,0x28f5_c28f_5c28_f5c2n,0x8f5c_28f5_c28f_5c28n,0xf5c2_8f5c_28f5_c290n ],// ***
    // 4: 2^(2^3) =   2^8 =   256 = 0.256e3
    [ 3n,0x4189_374b_c6a7_ef9dn,0xb22d_0e56_0418_9374n,0xbc6a_7ef9_db22_d0e6n ],// ***
    // 5: 2^(2^4) =   2^16 =   65536 = 0.65536e5
    [ 5n,0xa7c5_ac47_1b47_8423n,0x0fcf_80dc_3372_1d53n,0xcddd_6e04_c059_2104n ],// 6: 2^(2^5) =   2^32 =   4294967296 = 0.4294967296e10
    [ 10n,0x6df3_7f67_5ef6_eadfn,0x5ab9_a207_2d44_268dn,0x97df_837e_6748_956en ],// 7: 2^(2^6) =   2^64 =   18446744073709551616 = 0.18446744073709551616e20
    ...
    [ 39n,0x571c_bec5_54b6_0dbbn,0xd5f6_4baf_0506_840dn,0x451d_b70d_5904_029bn ],// 9: 2^(2^8) =   2^256 =
    ...
    [ 78n,0x1da4_8ce4_68e7_c702n,0x6520_247d_3556_476dn,0x1469_caf6_db22_4cfan ],// ***
    // 10: 2^(2^9) =   2^512 =
    ...
    [ 155n,0x2252_f0e5_b397_69dcn,0x9ae2_eea3_0ca3_ade0n,0xeeaa_3c08_dfe8_4e30n ],// 11: 2^(2^10) =   2^1024 =
    ...
    [ 309n,0x2e05_5c9a_3f6b_a793n,0x1658_3a81_6eb6_0a59n,0x22c4_b082_6cf1_ebf7n ],// 12: 2^(2^11) =   2^2048 =
    ...
    [ 617n,0x52bb_45e9_cf23_f17fn,0x7688_c076_06e5_0364n,0xb344_79aa_9d44_9a57n ],// 13: 2^(2^12) =   2^4096 =
    ...
    [ 1234n,0x1abc_81c8_ff5f_846cn,0x8f5e_3c98_53e3_8c97n,0x4506_0097_f3bf_9296n ],// 14: 2^(2^13) =   2^8192 =
    ...
    [ 2467n,0x1bec_53b5_10da_a7b4n,0x4836_9ed7_7dbb_0eb1n,0x3b05_587b_2187_b41en ],// 15: 2^(2^14) =   2^16384 =
    ...
    [ 4933n,0x1e75_063a_5ba9_1326n,0x8abf_b8e4_6001_6ae3n,0x2800_8702_d29e_8a3cn ],// 16: 2^(2^15) =   2^32768 =
    ...
    [ 9865n,0x243c_5d8b_b5c5_fa55n,0x40c6_d248_c588_1915n,0x4c0f_d99f_d5be_fc22n ],// 17: 2^(2^16) =   2^65536 =
    ...
    [ 19729n,0x334a_5570_c3f4_ef3cn,0xa13c_36c4_3f97_9c90n,0xda7a_c473_555f_b7a8n ],// 18: 2^(2^17) =   2^131072 =
    ...
    [ 39457n,0x66c3_0444_5dd9_8f3bn,0xa8c2_93a2_0e47_a41bn,0x4c5b_03dc_1260_4964n ],// 19: 2^(2^18) =   2^262144 =
    ...
    [ 78914n,0x293f_fbf5_fb02_8cc4n,0x89d3_e5ff_4423_8406n,0x369a_339e_1bfe_8c9bn ],// 20: 2^(2^19) =   2^524288 =
    ...
    [ 157827n,0x4277_92fb_b68e_5d20n,0x7b29_7cd9_fc15_4b62n,0xf091_4211_4aa9_a20cn ],// 21: 2^(2^20) =   2^1048576 =
    ...
    [ 315653n,0xac92_bc65_ad5c_08fcn,0x00be_eb11_5a56_6c19n,0x4ba8_82d8_a462_2437n ],// 22: 2^(2^21) =   2^2097152 =
    ...
    [ 631306n,0x7455_8144_0f92_e80en,0x4da8_22cf_7f89_6f41n,0x509d_5986_7816_4ecdn ],// 23: 2^(2^22) =   2^4194304 =
    ...
    [ 1262612n,0x34dd_99b4_c695_23a5n,0x64bc_2e8f_0d8b_1044n,0xb03b_1c96_da5d_d349n ],// 24: 2^(2^23) =   2^8388608 =
    ...
    [ 2525223n,0x6d2b_bea9_d6d2_5a08n,0xa0a4_606a_88e9_6b70n,0x1820_63bb_c2fe_8520n ],// 25: 2^(2^24) =   2^16777216 =
    ...
    [ 5050446n,0x2e8e_47d6_3bfd_d6e3n,0x2b55_fa89_76ea_a3e9n,0x1a6b_9d30_8641_2a73n ],// 26: 2^(2^25) =   2^33554432 =
    ...
    [ 10100891n,0x54aa_68ef_a1d7_19dfn,0xd850_5806_612c_5c8fn,0xad06_8837_fee8_b43an ],// 27: 2^(2^26) =   2^67108864 =
    ...
    [ 20201782n,0x1c00_464c_cb7b_ae77n,0x9e38_7778_4c77_982cn,0xd94a_f3b6_1717_404fn ],// 28: 2^(2^27) =   2^134217728 =
    ...
    [ 40403563n,0x1ea0_99c8_be2b_6cd0n,0x8bfb_6d53_9fa5_0466n,0x6d3b_c37e_69a8_4218n ],// 29: 2^(2^28) =   2^268435456 =
    ...
    [ 80807125n,0x24a4_57f4_66ce_8d18n,0xf2c8_f3b8_1bc6_bb59n,0xa78c_7576_92e0_2d49n ],// 30: 2^(2^29) =   2^536870912 =
    ...
    [ 161614249n,0x3472_5667_7aba_6b53n,0x3fbf_90d3_0611_a67cn,0x1e03_9d87_e0bd_b32bn ],// 31: 2^(2^30) =   2^1073741824 =
    ...
    [ 323228497n,0x6b72_7daf_0fd3_432an,0x71f7_1121_f9e4_200fn,0x8fcd_9942_d486_c10cn ],// 32: 2^(2^31) =   2^2147483648 =
    ...
    [ 646456994n,0x2d18_e844_84d9_1f78n,0x4079_bfe7_829d_ec6fn,0x2155_1643_e365_abc6n ] ];

  // An array of negative powers of two, each value consists of 4 longs: decimal exponent and 3 x 64
  // bits of mantissa, divided by ten. Used to find an arbitrary power of 2 (by powerOfTwo(long exp))
  static NEG_POWERS_OF_2: bigint[][] = [ // v18
    // 0: 2^0 =   1 = 0.1e1
    [ 1n,0x1999_9999_9999_9999n,0x9999_9999_9999_9999n,0x9999_9999_9999_999an ],// 1: 2^-(2^0) =   2^-1 =   0.5 = 0.5e0
    [ 0n,0x8000_0000_0000_0000n,0x0000_0000_0000_0000n,0x0000_0000_0000_0000n ],// 2: 2^-(2^1) =   2^-2 =   0.25 = 0.25e0
    //      {0, 0x4000_0000_0000_0000L, 0x0000_0000_0000_0000L, 0x0000_0000_0000_0000L},
    [ 0n,0x4000_0000_0000_0000n,0x0000_0000_0000_0000n,0x0000_0000_0000_0001n ],// ***
    // 3: 2^-(2^2) =   2^-4 =   0.0625 = 0.625e-1
    [ -1n,0xa000_0000_0000_0000n,0x0000_0000_0000_0000n,0x0000_0000_0000_0000n ],// 4: 2^-(2^3) =   2^-8 =   0.00390625 = 0.390625e-2
    [ -2n,0x6400_0000_0000_0000n,0x0000_0000_0000_0000n,0x0000_0000_0000_0000n ],// 5: 2^-(2^4) =   2^-16 =   0.0000152587890625 = 0.152587890625e-4
    [ -4n,0x2710_0000_0000_0000n,0x0000_0000_0000_0000n,0x0000_0000_0000_0001n ],// ***
    // 6: 2^-(2^5) =   2^-32 =   2.3283064365386962890625E-10 = 0.23283064365386962890625e-9
    [ -9n,0x3b9a_ca00_0000_0000n,0x0000_0000_0000_0000n,0x0000_0000_0000_0001n ],// ***
    // 7: 2^-(2^6) =   2^-64 =   5.42101086242752217003726400434970855712890625E-20 =
    // 0.542101086242752217003726400434970855712890625e-19
    [ -19n,0x8ac7_2304_89e8_0000n,0x0000_0000_0000_0000n,0x0000_0000_0000_0000n ],// 8: 2^-(2^7) =   2^-128 =
    ...
    [ -38n,0x4b3b_4ca8_5a86_c47an,0x098a_2240_0000_0000n,0x0000_0000_0000_0001n ],// ***
    // 9: 2^-(2^8) =   2^-256 =
    ...
    [ -77n,0xdd15_fe86_affa_d912n,0x49ef_0eb7_13f3_9eben,0xaa98_7b6e_6fd2_a002n ],// 10: 2^-(2^9) =   2^-512 =
    ...
    [ -154n,0xbeee_fb58_4aff_8603n,0xaafb_550f_facf_d8fan,0x5ca4_7e4f_88d4_5371n ],// 11: 2^-(2^10) =   2^-1024 =
    ...
    [ -308n,0x8e67_9c2f_5e44_ff8fn,0x570f_09ea_a7ea_7648n,0x5961_db50_c6d2_b888n ],// ***
    // 12: 2^-(2^11) =   2^-2048 =
    ...
    [ -616n,0x4f37_1b33_99fc_2ab0n,0x8170_041c_9feb_05aan,0xc7c3_4344_7c75_bcf6n ],// 13: 2^-(2^12) =   2^-4096 =
    ...
    [ -1233n,0xf51e_9281_7901_3fd3n,0xde4b_d12c_de4d_985cn,0x4a57_3ca6_f94b_ff14n ],// 14: 2^-(2^13) =   2^-8192 =
    ...
    [ -2466n,0xeab3_8812_7bcc_aff7n,0x1667_6391_42b9_fbaen,0x775e_c999_5e10_39fbn ],// 15: 2^-(2^14) =   2^-16384 =
    ...
    [ -4932n,0xd72c_b2a9_5c7e_f6ccn,0xe81b_f1e8_25ba_7515n,0xc2fe_b521_d6cb_5dcdn ],// 16: 2^-(2^15) =   2^-32768 =
    ...
    [ -9864n,0xb4dc_1be6_6045_02dcn,0xd491_079b_8eef_6535n,0x578d_3965_d24d_e84dn ],// ***
    // 17: 2^-(2^16) =   2^-65536 =
    ...
    [ -19728n,0x7fc6_447b_ee60_ea43n,0x2548_da5c_8b12_5b27n,0x5f42_d114_2f41_d349n ],// ***
    // 18: 2^-(2^17) =   2^-131072 =
    ...
    [ -39456n,0x3fc6_5180_f88a_f8fbn,0x6a69_15f3_8334_9413n,0x063c_3708_b6ce_b291n ],// ***
    // 19: 2^-(2^18) =   2^-262144 =
    ...
    [ -78913n,0x9ee0_197c_8dcd_55bfn,0x2b2b_9b94_2c38_f4a2n,0x0f8b_a634_e9c7_06aen ],// 20: 2^-(2^19) =   2^-524288 =
    ...
    [ -157826n,0x6299_63a2_5b8b_2d79n,0xd00b_9d22_86f7_0876n,0xe970_0470_0c36_44fcn ],// ***
    // 21: 2^-(2^20) =   2^-1048576 =
    ...
    [ -315652n,0x25f9_cc30_8cee_f4f3n,0x40f1_9543_911a_4546n,0xa2cd_3894_52cf_c366n ],// 22: 2^-(2^21) =   2^-2097152 =
    ...
    [ -631305n,0x3855_97b0_d47e_76b8n,0x1b9f_67e1_03bf_2329n,0xc311_9848_5959_85f7n ],// 23: 2^-(2^22) =   2^-4194304 =
    ...
    [ -1262611n,0x7bf7_95d2_76c1_2f66n,0x66a6_1d62_a446_659an,0xa1a4_d73b_ebf0_93d5n ],// ***
    // 24: 2^-(2^23) =   2^-8388608 =
    ...
    [ -2525222n,0x3c07_d96a_b1ed_7799n,0xcb73_55c2_2cc0_5ac0n,0x4ffc_0ab7_3b1f_6a49n ],// ***
    ...
    [ -5050445n,0x8cc4_cd8c_3ede_fb9an,0x6c8f_f86a_90a9_7e0cn,0x166c_fddb_f98b_71bfn ],// ***
    ...
    [ -10100890n,0x4d67_d81c_c88e_1228n,0x1d7c_fb06_666b_79b3n,0x7b91_6728_aaa4_e70dn ],// ***
    ...
    [ -20201781n,0xea0c_5549_4e7a_552dn,0xb88c_b948_4bb8_6c61n,0x8d44_893c_610b_b7dFn ],// ***
    ...
    [ -40403562n,0xd5fa_8c82_1ec0_c24an,0xa80e_46e7_64e0_f8b0n,0xa727_6bfa_432f_ac7en ],// 29: 2^-(2^28) =   2^-268435456 =
    ...
    [ -80807124n,0xb2da_e307_426f_6791n,0xc970_b82f_58b1_2918n,0x0472_592f_7f39_190en ],// 30: 2^-(2^29) =   2^-536870912 =
    ...
    [ -161614248n,0x7cf5_1edd_8a15_f1c9n,0x656d_ab34_98f8_e697n,0x12da_a2a8_0e53_c807n ],// 31: 2^-(2^30) =   2^-1073741824 =
    ...
    [ -323228496n,0x3cfe_609a_b588_3c50n,0xbec8_b5d2_2b19_8871n,0xe184_7770_3b46_22b4n ],// 32: 2^-(2^31) =   2^-2147483648 =
    ...
    [ -646456993n,0x9152_447b_9d7c_da9an,0x3b4d_3f61_10d7_7aadn,0xfa81_bad1_c394_adb4n ] ];
  ...
  doAvoidDecimal128CollisionsWithDouble() : void {
    // Collisions may occur when the result matches some double.
    if (this.mantLo == 0n && (this.mantHi & 0XFFFn) == 0n) {
  ...
  parseMantissa(digits: number[],mantissa: bigint[]) : number {
    ...
    if ((digits).length - firstDigit > QuadrupleBuilder.MAX_MANTISSA_LENGTH) {
      ...
      let  truncated: number[] = new Array(QuadrupleBuilder.MAX_MANTISSA_LENGTH).fill(0);;
    ...
    for (let  i = ((digits).length) - 1; i >= (firstDigit); i--) { // digits, starting from the last
  ...
  addCarry(digits: number[]) : number {
    for (let  i = ((digits).length) - 1; i >= (0); i--) { // starting with the lowest digit
  ...
  findBinaryExponent(exp10: number,mantissa: bigint[]) : number {
    ...
    return Math.floor(Number(exp10) * QuadrupleBuilder.LOG2_10 + this.log2(mant10d)); // Binary exponent
  }
  ...
  findBinaryMantissa(exp10: number,exp2: number,mantissa: bigint[]) : void {
    ...
    // higher bits.
    this.addToBuff(product, 5, QuadrupleBuilder.MAX_ERROR); // to compensate possible inaccuracy
    // true if bits 128-191 are within 2 * MAX_ERROR, i.e., the conversion appears exact
    let exact192: boolean = product[4] == 0n && product[5] >= 0n && product[5] <= 2n * QuadrupleBuilder.MAX_ERROR;
  ...
  multPacked3x64_AndAdjustExponent(factor1: bigint[],factor2: bigint[],result: bigint[]) : void {
  ...
  multPacked3x64_simply(factor1: bigint[],factor2: bigint[],result: bigint[]) : void {
    ...
    for (let  i = (6) - 1; i >= (0); i--) { // compute partial 32-bit products
      for (let  j = (6) - 1; j >= (0); j--) {
        let part: bigint = this.buffer6x32A[i] * this.buffer6x32B[j];
        result[j + i + 1] = ((result[j + i + 1] + (part & QuadrupleBuilder.LOWER_32_BITS)) & 0xffffffffffffffffn);
    ...
    for (let  i = (12) - 1; i >= (1); i--) {
      result[i - 1] = ((result[i - 1] + ((result[i]) >> (32n))) & 0xffffffffffffffffn);
  ...
  correctPossibleUnderflow(mantissa: bigint[]) : number {
    ...
    while (this.isLessThanOne(mantissa)) { // Underflow
  ...
  multUnpacked6x32byPacked(factor1: bigint[],factor2: bigint[],product: bigint[]) : void {
    ...
    for (let  i = (maxFactIdx) - 1; i >= (0); i--) { // compute partial 32-bit products
      for (let  j = (maxFactIdx) - 1; j >= (0); j--) {
        let part: bigint = factor1[i] * unpacked2[j];
        product[j + i + 1] = ((product[j + i + 1] + (part & QuadrupleBuilder.LOWER_32_BITS)) & 0xffffffffffffffffn);
    ...
    // Carry higher bits of the product to the lower bits of the next word
    for (let  i = (12) - 1; i >= (1); i--) {
      product[i - 1] = ((product[i - 1] + ((product[i]) >> (32n))) & 0xffffffffffffffffn);
  ...
  multBuffBy10(buffer: bigint[]) : void {
    ...
    for (let  i = (maxIdx) - 1; i >= (0); i--) {
      buffer[i] = ((buffer[i] * 10n + ((buffer[i + 1]) >> (32n))) & 0xffffffffffffffffn);
  ...
  divBuffByPower2(buffer: bigint[],exp2: number) : void {
    ...
    if (exp2 > 0) { // Shift to the right
      ...
      for (let  i = (maxIdx + 1) - 1; i >= (1); i--) {
        buffer[i] = ((buffer[i]) >> (exp2Shift)) | ((buffer[i - 1] << backShift) & QuadrupleBuilder.LOWER_32_BITS);
      }
      buffer[0] = ((buffer[0]) >> (exp2Shift)); // Preserve the high half of buff[0]
    } else if (exp2 < 0) { // Shift to the left
      let exp2Shift: bigint = BigInt(-exp2);
      buffer[0] = (((buffer[0] << exp2Shift) | ((buffer[1]) >> (backShift))) & 0xffffffffffffffffn); // Preserve the high half of buff[0]
      for (let  i = (1); i < (maxIdx); i++) {
        buffer[i] = ((((buffer[i] << exp2Shift) & QuadrupleBuilder.LOWER_32_BITS) | ((buffer[i + 1]) >> (backShift))) & 0xffffffffffffffffn);
      }
      buffer[maxIdx] = (buffer[maxIdx] << exp2Shift) & QuadrupleBuilder.LOWER_32_BITS;
    }
  }
  ...
  addToBuff(buff: bigint[],idx: number,summand: bigint) : void {
    ...
    for (let  i = (maxIdx + 1) - 1; i >= (1); i--) {              // from the lowest word upwards, except the highest
